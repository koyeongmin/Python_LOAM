...
class Optimizer_Loam:
    ...
    def resid_function(self, x):
        ...
        surface_resid = np.abs(utils.matrix_row_wise_dot_product(aligned_surface - self.surface_factors[1], normal))
    ...
    def resid_function_2(self, x):
        ...
        surface_resid = utils.matrix_row_wise_dot_product(aligned_surfaces, self.surface_factors[1]) + \
